...
resource "azurerm_storage_account" "sg1" { 
 name      =  "csestologo4eddc" # add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
...
resource "azurerm_storage_account" "sg2" { 
 name      =  "csestologs4eddc" # add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
 resource_group_name   =  var.rg_name
 location     =  var.location
 # Performance tier: Standard (HDD-backed)
 account_tier    =  "Standard" 
...
name    =  "sqlserver4eddc" # add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.

location    =  var.location 
resource_group_name  =  var.rg_name  
administrator_login   =  "eddc" 
administrator_password =  "WxbMDPAdmin6!"
